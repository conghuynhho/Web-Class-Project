		...
		<div class="container">
			<div class="row">
				<div class="col d-flex flex-lg-row flex-column align-items-center justify-content-start">
					...
					<div class="deals">
						<div class="deals_title">Deals trong tuần</div>
								...
								<div class="owl-item deals_item">
									...
									<div class="deals_content">
										<div class="deals_info_line d-flex flex-row justify-content-start">
											<div class="deals_item_category"><a href="{{route('themgiohang',$new->id)}}" style="color:#b72e3b">Mua ngay</a></div>
											<div class="deals_item_price_a ml-auto"><del>{{number_format($new ->giadau)}}₫</del></div>
										</div>
										<div class="deals_info_line d-flex flex-row justify-content-start">
										...
										<div class="available">
											<div class="available_line d-flex flex-row justify-content-start">
												<div class="available_title">Đã bán: <span>
													<?php 
														print_r($new->soluong*2);
													 ?>
												</span></div>
												<div class="sold_title ml-auto">Có sẵn: <span>{{$new->soluong}}</span></div>
											</div>
											<div class="available_bar"><span style="width:66%"></span></div>
										</div>
									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											...
											<div class="product_content">
												<div class="product_price discount">{{number_format($sp->giasau)}}₫<span><del>{{number_format($sp->giadau)}}</del></span></div>
