					...
					<div class="contact_form_container">
						...
						<form action="" role='form' method="post">
							<div class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
								<input type="text" name="note_name" class="contact_form_name input_field" placeholder="Họ Tên" required="required" data-error="Bắt buộc">
								<input type="text" name="note_email" class="contact_form_email input_field" placeholder="email" required="required" data-error="Bắt buộc">
								<input type="text" name="note_number" class="contact_form_phone input_field" placeholder="Số Điện Thoại">
							</div>
							<div class="contact_form_text">
								<textarea id="contact_form_message" name="note_text" class="text_field contact_form_message" name="message" rows="5" placeholder="Lời Nhắn" required="required" data-error="Hãy viết lời nhắn."></textarea>
							</div>
							<div class="contact_form_button">
								<button type="submit" name="add_contact" class="button contact_submit_button">Gửi</button>
							</div>
						</form>
