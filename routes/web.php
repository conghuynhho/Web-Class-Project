...
Route::get('/admin-logout','AdminControler@admin_logout');
...
//Contact
Route::get('/add-contact','ContactController@add_contact')->name('lienhe');
Route::get('/list-contact','ContactController@list_contact');
Route::post('add-contact','ContactController@post_add_contact')->name('lienhe');

Route::get('/handle/{id}','ContactController@handle');
Route::get('/unhandle/{id}','ContactController@unhandle');
